...
var messages = map[string]map[string]string{
	"ru": {
		...
		"OTP_MAX_ATTEMPTS":        "Превышен лимит запросов OTP. Попробуйте через 10 минут",
	...
	"uz": {
		...
		"OTP_MAX_ATTEMPTS":        "OTP so'rovlar limiti oshib ketdi. 10 daqiqadan keyin urinib ko'ring",
	...
	"en": {
		...
		"OTP_MAX_ATTEMPTS":        "OTP request limit exceeded. Try again in 10 minutes",
